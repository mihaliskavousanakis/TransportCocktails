...
%options = odeset('Mass',Mass,'Jacobian',@(t,y) liposomes_jac(t,y,xpt,DL,hd,kd,xpor,Dd,phiD,0));
options = odeset('Mass',Mass,'Jacobian',@(t,y) liposomes_jac(t,y,xpt,DL,hd,xpor,Dd,phiD,0));

% tspan: measured in hrs

%[t,y] = ode15s(@(t,y) liposomes(t,y,xpt,DL,hd,kd,xpor,Dd,phiD,0), tspan, y0, options);
